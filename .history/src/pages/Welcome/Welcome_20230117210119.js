  ...
  return (
    <>
      ...
      {/* <section className="col-md-12 flexy page-background">
        <div className="col-md-12 page-shadow module1 parallax parallax-3">
      ...
      <section>
        <div className="col-md-12 trial module1 parallax parallax-3">
          <h1>welcome</h1>
          <h1>welcome</h1>
        </div>
      </section>
      <section className="page-content flexy module1 contentt contact-form prefooter-container">
        <div className="col-md-2">&nbsp;</div>
        <div className="col-md-8">
