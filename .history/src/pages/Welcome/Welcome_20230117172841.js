                    ...
                    <div className="search-container">
                      ...
                      <ul className="list-unstyled">
                        ...
                        <li>
                          ...
                          <ul className="list-unstyled">
                            <li><Link to="#" className="link-alteration">State of the School</Link></li>
                            <li><Link to="#" className="link-alteration">Strategic Plan</Link></li>
                            <li><Link to="#" className="link-alteration">BEST Practices</Link></li>
                          </ul>
                        </li>
                      </ul>
                    </div>
