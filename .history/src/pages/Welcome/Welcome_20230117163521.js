      ...
      <div className="page-content flexy">
        ...
        <div className="col-md-8">
          ...
          <ul className="list-inline list-unstyled">
            <li><Link to="#" className="link-alteration">Welcome</Link></li>
            <li><Link to="#" className="link-alteration">Phylosophy</Link></li>
            <li><Link to="#" className="link-alteration">Leadership</Link></li>
            <li><Link to="#" className="link-alteration">Calendar <span></span></span></Link></li>
            <li><Link to="#" className="link-alteration"></Link></li>
          </ul>
        </div>
      </div>
