        ...
        <div className="tour-schedule  col-md-12 flexy">
          <div className=" col-md-12 after flexy">
            ...
            <div className="col-md-12 ">
              ...
              <div className="image1 col-md-12">
                <div className="overlay col-md-12">
                  <div className="col-md-9">
                    <center>
                      ...
                      <h1 className="col-md-3 mb3">Schedule a Tour</h1>
                      <h3>
                        We invite you to experience the value of a The First
                        Academy education for yourself by scheduling a{" "}
                        <Link to={"#"} className="banner-link">
                          visit to campus.
                        </Link>
                        See our upcoming{" "}
                        ...
                        or request a private tour. We look forward to showing
                        you around and sharing more about the opportunities
