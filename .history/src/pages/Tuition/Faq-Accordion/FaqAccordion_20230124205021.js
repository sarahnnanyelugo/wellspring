  ...
  return (
    <Accordion defaultActiveKey="0">
      ...
      <Accordion.Item eventKey="1">
        ...
        <Accordion.Body>
          <p>
            TFA is accredited by the Florida Council of Independent Schools
            (FCIS), the Florida Kindergarten Council (FKC), the Southern
            Association of Independent Schools (SAIS), the Southern Association
            of Colleges and Schools (SACS), and the Association of Christian
      ...
      <Accordion.Item eventKey="2">
        ...
        <Accordion.Body>
          <p>
            <strong>
              Graphic Standards convey guidance to the TFA Community in
              designing consistent products.
            </strong>{" "}
          ...
          <p>
            ...
            guide for proper usage of The First Academy logos, colors, and
            media.
          </p>
      ...
      <Accordion.Item eventKey="3">
        ...
        <Accordion.Body>
          <ul className="list-unstyled logo-files">
            <li>
              The First Academy Wordmark{" "}
              <a href={"#"} target="_blank">
                (Download Wordmark)
              </a>
            </li>
            <li>
              The First Academy Athletics Spirit Icon – Lion Head{" "}
              <a href={"#"} target="_blank">
                (Download Spirit Icons)
              </a>
            </li>
            <li>
              The First Academy Athletics – Lion{" "}
              <a href={"#"} target="_blank">
                (Download Lion Logos)
              </a>
            </li>
            <li>
              The First Academy Athletics – Royals{" "}
              <a href={"#"} target="_blank">
