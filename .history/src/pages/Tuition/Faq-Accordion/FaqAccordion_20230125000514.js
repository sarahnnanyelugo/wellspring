...
"
        ...
        <Accordion.Item eventKey="2">
          ...
          <Accordion.Body>
            <p>We offer two payment plan options:</p>
            <div className="flexy">
              <span>
              ...
              <div>
                <h6>Monthly</h6>
                <p>
                  will be withdrawn by SwitchApp Tuition from a bank account. Pay
                  dates to choose from are the 5th or 15th of each month. For
                  monthly payment plans, there is a one-time service charge of
                  $250 per student.
                </p>
              </div>
            </div>
