      ...
      <div className="col-md-12 fees-table">
        ...
        <div className="col-md-12 flexy">
          ...
          <div className="col-md-8">
            ...
            <p>
              As you consider The First Academy, we welcome your questions about
              tuition, payment plans, or whatever else comes to mind. Our
            ...
            <p>
              ...
              find out that a The First Academy education is truly affordable to
              them.{" "}
            </p>
            <p>
