...
export const Tuition = () => {
  ...
  return (
    <>
      ...
      <div className="col-md-12 flexy quote mt7">
        {" "}
        <div className="col-md-1">&nbsp;</div>
        <div className="col-md-4">
          {" "}
        ...
        <div className="col-md-1">&nbsp;</div>
        <div className="col-md- mt4">
          <p>
            There are things a private Christian education can offer your child
            — academics taught from a biblical perspective, enrichment
            opportunities to learn, serve, and lead, teachers who model
            Christian values — and you know that your child’s environment will
            impact their academic readiness and spiritual formation.
          </p>
        </div>
      </div>{" "}
      <section className="page-content flexy ">
