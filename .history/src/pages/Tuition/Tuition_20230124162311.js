        ...
        <div className="col-md-10">
          <div className="col-md-11">
            ...
            <center>
              <h1>
                <strong>
                  At <Link to={"#"} className="random">Wellspring College</Link>we have been
                  ensuring our graduates are prepared for college, careers, and
                  serving their communities. How do we do it?
                </strong>
              </h1>
            </center>
