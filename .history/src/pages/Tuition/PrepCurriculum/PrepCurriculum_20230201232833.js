    ...
    <>
      <div className="prep-container mt5 display-web">
        <div className="col-md-12 flexy">
          ...
          <div className="col-md-9 prep-box mt2">
            <p>
        ...
        <div className="col-md-12 flexy">
          ...
          <div className="col-md-9 prep-box mt2">
            <p>
              ...
              foreign language or performing on stage, there is an opportunity
              for exploration.
            </p>
          </div>
        ...
        <div className="col-md-12 flexy">
          ...
          <div className="col-md-9 prep-box mt2s">
            <p>
              ...
              study, Living Curriculum teachers, and guidance counselors on
              staff.
            </p>
          </div>
        </div>{" "}
      </div>
      <div className="prep-container mt5 display-mobile">
        <div className="col-md-12 flexy">
          <div className="col-md-3 prep-icon flexy mt4">
            <span>
              <i class="icofont-trophy"></i>
        ...
        <div className="col-md-12 flexy">
          <div className="col-md-3 prep-icon2 flexy mt4">
            <span>
              <i class="icofont-music"></i>
            </span>
          </div>
