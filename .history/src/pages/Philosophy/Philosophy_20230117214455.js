      ...
      <section className="page-content flexy ">
        ...
        <div className="col-md-8">
          <div className="col-md-11">
            ...
            <p>
              received over $105 million in scholarship offers. TFA students at
              every grade level consistently score well above the state and
              national average on standardized tests. Our Head of School, Dr.
              Steve Whitaker, and our exceptionally qualified faculty and staff
              invite you to tour our website, then join us in person for a visit
              to our campus. Once here, you will remember us for our greatest
              achievement – equipping young men and women to fulfill God’s
              purpose for their lives with extraordinary integrity,
              unquestionable ability, and life-long service to the global
              community.
              <br /> <br />
            </p>
            <ul className="list-unstyled">
