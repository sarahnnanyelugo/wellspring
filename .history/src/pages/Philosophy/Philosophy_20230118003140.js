...
export const Philosophy = () => {
  ...
  return (
    <>
      ...
      <div className="col-md-12 prospect flexy">
        <div className="col-md-3">&nbsp;</div>
        <div className="col-md-6 flexy">
          <div className="col-md-3">
            <img className="col-md-12 " src={Merged} alt="Scholar" />
          </div>
          <div className="col-md-5">
            <h1>
              Searching for the Right Private Christian School for Your Family? Take a
              closer look with our Parent Info Packet
            </h1>
          </div>
          <div className="col-md-4">
            <h5>Take a closer look with our Parent Info Packet</h5>
            <button>DOWNLOAD NO</button>
          </div>
        </div>
      </div>
