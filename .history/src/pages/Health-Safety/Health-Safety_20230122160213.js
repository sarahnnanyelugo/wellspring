...
<h1 className="page-headings mb3">Safety Reporting</h1>
           ...
           <h1 className="page-headings mb3">Safety Resources
</h1>
            ...
            <ul className="list-unstyled">
              ...
              <li>
                {" "}
                <img className="col-md-12 dot" src={Blue} alt="Scholar" /><Link to={"/"} className="link-alteration2"></Link>
              </li>
              <li>
                {" "}
                <img className="col-md-12 dot" src={Blue} alt="Scholar" />
                For After Hours Non-Emergency Safety Concerns, please call 407-514-4434
