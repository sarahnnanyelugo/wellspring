...
<h1 className="page-headings mb3">Safety Reporting</h1>
            ...
            <p>
              Should you have any questions, please direct your attention to <Link to={"/"} className="">Brian Rose</Link>, Assistant Head of School and Director of Safety & Security.
            </p>
            <ul className="list-unstyled">
              <li>
                {" "}
