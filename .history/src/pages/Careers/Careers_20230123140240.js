...
<p>Thank you for your interest in employment at The First Academy. Please take a moment to review the available 
  ...
  <ol>
    ...
    <li>Your ‘New Account Passwords’ will be sent to your email address (check your spam). Not receiving your password? See <Link to={"#"}>Troubleshooting Registration </Link>listed beneath the open positions.</li>
    ...
    <li>Please navigate back to the  <Link to={"#"}>Job Openings section</Link> and click the appropriate application listed below or from the opening descriptions</li>
