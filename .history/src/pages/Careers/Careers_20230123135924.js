...
<p>Thank you for your interest in employment at The First Academy. Please take a moment to review the available 
  ...
  <ol>
    ...
    <li>Your ‘New Account Passwords’ will be sent to your email address (check your spam). Not receiving your password? See <Link to={"#"}>Troubleshooting Registration listed beneath the open positions.</li>
    <li><Link to={"#"} className="career-link">Register for an Account</Link></li>
    <li><Link to={"#"} className="career-link">Register for an Account</Link></li>
