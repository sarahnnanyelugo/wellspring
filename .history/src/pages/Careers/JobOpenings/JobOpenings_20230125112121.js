...
const positions = [
  ...
  "Varsity Girls Volleyball Coaches",
];
export const JobOpenings = () => {
  const listItems = positions.map((person) => (
    <li>
      ...
      <div class="diversity-tab-container3">
        <div class="tab-wrap">
          ...
          <div class="tab__content">
            ...
            <p>
              Wellspring College has the following Staff Position openings at
              this time.
            </p>
            <ul className="list-unstyled job-openings-list">
              <li>
                ...
                <ul>
                  <li>
                    Wellspring College is now accepting applications for
                    part-time
                    <Link to={"#"} className="career-link">
              ...
              <li>
                ...
                <ul>
                  <li>
                    Wellspring College is now accepting applications for a
                    part-time
                    <Link to={"#"} className="career-link">
              ...
              <li>
                ...
                <ul>
                  <li>
                    TWellspring College is now accepting applications for a
                    full-time
                    <Link to={"#"} className="career-link">
          ...
          <div class="tab__content">
            ...
            <small>
              ...
              <span></span> leads to the machine-readable files that are made
