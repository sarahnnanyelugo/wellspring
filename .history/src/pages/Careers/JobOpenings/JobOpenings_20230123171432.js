      ...
      <div class="job-openings-container">
        <div class="tab-wrap">
          ...
          <div class="tab__content">
            ...
            <small>
              <em>Transparency in Insurance Coverage Rule Disclaimer:</em>This link leads to the machine-readable files that are
              made available in response to the federal Transparency in Coverage
              Rule and includes negotiated service rates and out-of-network
              allowed amounts between health plans and healthcare providers. The
