...
<p>Thank you for your interest in employment at The First Academy. Please take a moment to review the available 
  ...
  <ol>
    ...
    <li><Link to={"#"} className="career-link">Your ‘New Account Passwords’ will be sent to your email address (check your spam). Not receiving your password? See Troubleshooting Registration listed beneath the open positions.</Link></li>
    <li><Link to={"#"} className="career-link">Register for an Account</Link></li>
    <li><Link to={"#"} className="career-link">Register for an Account</Link></li>
