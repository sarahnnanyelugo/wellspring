...
<p>Thank you for your interest in employment at The First Academy. Please take a moment to review the available 
  ...
  <ol>
    ...
    <li>Your ‘New Account Passwords’ will be sent to your email address (check your spam). See <Link to={"#"} className="career-link">Troubleshooting Registration </Link>listed beneath the open positions.</li>
