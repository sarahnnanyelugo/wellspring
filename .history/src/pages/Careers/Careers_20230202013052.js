    ...
    <>
      <section className="col-md-12 flexy page-background ">
        <div className="col-md-12 page-shadow header-wrapper">
          ...
          <div className="icon ">
            <h1>Careers</h1>
            <h2>Making a difference in Central Florida</h2>
        ...
        <div className="col-md-10 careers-container">
          <div className="col-md-11">
            ...
            <p>
              ...
              ideas that inspires the excellence that runs through everything we
              do.
            </p>
            ...
            <p>
              On average, have better benefits, more time off, and higher pay
              than local public schools, helping us to attract and retain
              teachers longer than the public schools.
            </p>

            <p>
              Our students are here to learn, and you’ll never be reprimanded
              for sharing your testimony. It’s encouraged!
            </p>
            <p>
              We believe in being well-rounded, and to complement your standard
              continuing ed, you’ll grow in areas such as Christian leadership,
              CPR, and an array of technology.
            </p>
            <p>
              This is your chance for a meaningful career. Join our team and
              help make the next generation of Christian leaders. Find your
              career today!
            </p>
            <div className="flexy">
              <div className="col-md-4">
                <div className="col-md-11">
                  <Benefits
                    icon=<i class="icofont-upload-alt"></i>
                    description="Competitive Health and Retirement benefits"
                  />
                </div>
              </div>
              <div className="col-md-4">
                <div className="col-md-11">
                  <Benefits
                    icon=<i class="icofont-book-alt"></i>
                    description="Biblical integration is encouraged in every subject"
                  />
                </div>
              </div>
              <div className="col-md-4">
                <div className="col-md-11">
                  <Benefits
                    icon=<i class="icofont-graduate"></i>
                    description="Tuition discounts may be offered"
                  />
                </div>
              </div>
            </div>
            ...
            <p>
              ...
              department. If you would like more information about one of the
              positions posted below or have questions regarding the hiring
              process, please contact employment@thefirstacademy.org. For
              technical assistance with the Application, see the Troubleshooting
            ...
            <ol>
              ...
              <li>
                Your ‘New Account Passwords’ will be sent to your email address
                (check your spam).<strong> Not receiving your password?</strong>{" "}
                See{" "}
                <Link to={"#"} className="career-link">
                  Troubleshooting Registration{" "}
                </Link>
                listed beneath the open positions.
              </li>
              <li>
                Utilize the new password to log in. You will be brought to the
                User Profile page, these details are optional to fill out.
              </li>
              <li>
                ...
                and click the appropriate application listed below or from the
                opening descriptions
              </li>
              <li>
                After submitting the application, you will not be able to view
                the submission details or form (without re-completing an
                application). Please print or make a note of any documents you
                intend on emailing/faxing to our human resources department.
              </li>
            </ol>
            ...
            <h2 className="page-headings mt5">Apply Now</h2>
            <div className="col-md-12 flexy application-buttons">
              ...
              <div className="col-md-3">
                <div className="col-md-11">
                  <Link to={"/substitute-application"}>
            ...
            <h2 className="page-headings mt5">Job Openings</h2>
            <p>
              Day School refers to the Upper, Middle, and Lower School
              divisions, while Extended Educational Programs refer to The
              Classical School (Homeschool) and The First Hope (Special Needs)
              divisions.
            </p>
            <JobOpenings />
          </div>
