...
export const WhyWellspring = () => {
  ...
  return (
    <>
      ...
      <div>
        <center>
          <p className="col-md-7 mt7">
            Why do so many families from Orlando and Central Florida choose The
            First Academy to prepare their child for what’s next? Maybe it’s
            because of The First Academy’s Christ-centered community, culture,
            and curriculum, and how our students graduate equipped to excel in
            all areas of life — academically, professionally, spiritually and
            socially.
          </p>
          <h2 className="col-md-5">
            <em>
              Here are 10 of the many reasons why we’re Central Florida’s first
              choice in private Christian education:
            </em>
          </h2>
        </center>
      </div>
