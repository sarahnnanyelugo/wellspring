            ...
            <div className="col-md-4">
              ...
              <div className="col-md-11">
                ...
                <p>
                  ...
                  <Link to={"#"}> Living Curriculum </Link> teachers are committed to
                  their Christian faith and values, and have pledged to uphold
                  those beliefs inside and outside of the classroom, ensuring
                  our students have role models who consistently mirror
                  Christian living, loving, and learning.
                </p>
              </div>
            </div>
          </div>{" "}
          <div className="col-md-12 flexy mt7">
            <div className="col-md-4">
              ...
              <div className="col-md-11">
                ...
                <p>
                  ...
                  attention. Enrichment classes are available for students in
                  grades 1-5 who have been identified as academically talented
                  or gifted, and for Middle and Upper School students, our
                  Accelerated Pathways offers dual enrollment, Advanced
                  Placement, and concurrent course opportunities.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              ...
              <div className="col-md-11">
                ...
                <p>
                  ...
                  aquaponics facility is an interactive experience for learning
                  about biology, chemistry, marine biology, and sustainability.
            ...
            <div className="col-md-4">
              ...
              <div className="col-md-11">
                ...
                <p>
                  From the visual and performing arts to electives like Mandarin
                  and agricultural science, students can pursue interests,
                  passions, and curiosities. Creativity is expressed through
                  everything from performing in theatre class to creating
                  original content for Raw Footage, the Upper School’s broadcast
                  program. Professional pursuits are explored through electives,
                  clubs, organizations, service, and field trips.
                </p>
              </div>
            </div>
          </div>
          <div className="col-md-12 flexy mt7">
            <div className="col-md-4">
              ...
              <div className="col-md-11">
                ...
                <p>
                  Go Royals! TFA offers 32 sports at the Upper School level with
                  fun and competition starting as early as Preschool with flag
                  football and cheer. Our exceptional athletic facilities
            ...
            <div className="col-md-4">
              ...
              <div className="col-md-11">
                ...
                <p>
                  ...
                  dedicated College Guidance team helps students find best fit
                  schools and assists with navigating the college application
                  process. Graduating seniors have a 100% college acceptance
                  rate and earn millions of dollars in scholarships annually.
                </p>
              </div>
            </div>
          </div>
