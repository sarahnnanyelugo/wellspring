        ...
        <div className="col-md-8 flexy">
          ...
          <div className="col-md-4">
            ...
            <div className="col-md-11">
              <h2 className="lightblue">Joyful Learning</h2>
              <p>
          ...
          <div className="col-md-4">
            {" "}
            <div className="col-md-11">
              <h2 className="deepblue">
                Individually Known, Loved, and Valued
              </h2>
              <p>
                ...
                identified and nurtured. Personalized attention is the norm, not
                the exception.
              </p>
            </div>
          </div>
          <div className="col-md-4">
            {" "}
            <div className="col-md-11">
              <h2 className="skyblue">Christian Values Demonstrated Daily</h2>
              <p>
                We recognize that a child’s teachers play pivotal, influential
                roles in their life — day after day, year after year. Our Living
                Curriculum teachers are committed to their Christian faith and
                values, and have pledged to uphold those beliefs inside and
                outside of the classroom, ensuring our students have role models
                who consistently mirror Christian living, loving, and learning.
              </p>
            </div>
          </div>
        </div>
