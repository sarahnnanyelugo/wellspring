            ...
            <div className="col-md-4">
              ...
              <div className="col-md-11">
                ...
                <p>
                  ...
                  attention. <Link to={"#"} className="reasons-link"></Link>
                  Enrichment classes are available for students in grades 1-5
                  who have been identified as academically talented or gifted,
                  and for Middle and Upper School students, our Accelerated
                  Pathways offers dual enrollment, Advanced Placement, and
                  concurrent course opportunities.
                </p>
              </div>
            </div>
            <div className="col-md-4">
