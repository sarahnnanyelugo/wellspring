        ...
        <div className="tabs2 col-md-12">
          <div className="tabby-tab">
            ...
            <div className="tabby-content col-md-12">
              ...
              <p>
                Celebrate the start of the school year with our Wellspring College Family after
                Meet the Teacher on Monday, August 8 from 4:00-8:00 PM at the
                Chick-fil-A located at 4181 Millenia Blvd, Orlando.
              </p>
              <p>
                This Wellspring College Takeover is a Spirit Night event, with proceeds going
                to benefit Royal-Thon. Be sure to say you’re with Wellspring College when you
                order dine-in, drive-thru, or on mobile order (put Wellspring College Spirit
                Night in the comments section for all mobile orders).
              </p>
            </div>
          </div>
          <div className="tabby-tab">
