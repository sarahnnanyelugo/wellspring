        ...
        <div className="tabs col-md-12">
          ...
          <div className="tabby-tab">
            ...
            <div className="tabby-content">
              ...
              <p>
                <span style={{borderBottom:'solid 1px black'}}> Thursday, August 4th: </span>Middle and Upper School New
                Student Event ‘Schedules and Snow Cones’ from 2:00- 3:00 PM,
                Upper School Building. <br />
