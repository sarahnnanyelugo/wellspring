  ...
  return (
    <>
      ...
      <div className="col-md-12 flexy">
        <div className="col-md-6 flexy tour-container zoom">
        ...
        <div className="col-md-6 flexy store-container zoom">
          <div className="col-md-1">&nbsp;</div>
          <div className="col-md-5">
            <h1>
        ...
        <div classame="col-md-12 flexy">
          ...
          <div className="col-md-6">
            ...
            <p>
              ...
              exceptional leaders. We ensure that students are equipped with
              requisite 21st century skills by which they are empowered to
              provide winning solutions for tomorrow’s challenges. At Wellspring
              College, we seek every occasion to provide our students with
              opportunities for sound academic, mental, spiritual and social
              development. We ensure that for our students learning is not a
              challenge, it’s interesting, it’s fun, it’s hands-on. We
              continuously train unique, and exceptional students, which gives
              them the leverage to be distinct amongst their pears.
            </p>
          </div>
        </div>
