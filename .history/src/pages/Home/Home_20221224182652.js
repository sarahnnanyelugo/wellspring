...
import Grad from "../../assets/grad3.png";
      ...
      <div className="col-md-12 flexy achievement-container">
        ...
        <div className="col-md-6 flexy">
          <div className="col-md-5">
            ...
            <p>only one of seven schools honored in the state of Florida</p>
          </div>
          <div className="col-md-1">&nbsp;</div>
          <div className="col-md-6">
            ...
            <div>
              ...
              <p>of Missions/Service completed around the world since 2003</p>
            </div>
            <h1>100%</h1>
            <p>of TFA graduates have been accepted to college
