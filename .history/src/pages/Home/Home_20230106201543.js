  ...
  return (
    <>
      <div className="col-md-12 image-container">
        <img className="col-md-12 home-banners" src={Slide1} alt="Scholar" />
        <div className="after col-md-12 flexy" >
          ...
          <div className="col-md-3 logo-div">
            ...
            <img
              ...
              alt="Scholar"
            />
            <p>Being Named Central Florida’s Best Private Christian School Reflects Our Commitment to Excellence</p></p>
          </div>
        </div>
      </div>
      ...
      <div className="col-md-12 flexy flexyM blue-tab-container">
        <div className="col-md-2">&nbsp;</div>
        <div className="col-md-8 col-12 blue-tab">
          <div className="flexy">
            {" "}
      ...
      <div className="col-md-12 logo-display flexy animated-hero">
