...
export const Home = () => {
  return (
    <>
      ...
      <div className="col-md-12 giving-container">
        <div className="col-md-6">&nbsp;</div>
        <div className="col-md-3">
          ...
          <p>
            ...
            children for life as Christian leaders.” Through the faithfulness of
            God and the generosity of his people, The First Academy began
            impacting thousands of students’ lives. Since then, countless
            parents, grandparents and alumni have given generously, and today we
            ask that you, too, help make this possible.
          </p>
          <YellowAppButton text="GIVE NO"/>
        </div>
      </div>
    </>
  );
