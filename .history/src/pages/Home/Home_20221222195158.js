...
import Lib from "../../assets/read.png";
        ...
        <div className="col-md-4 picture-container">
          <div className="flexy">
            <div className="col-md-6">
              {" "}
              <img className="col-md-11 " src={Jersy} alt="First slide" />
            </div>
            <div className="col-md-6">
              {" "}
              <img className="col-md-11 " src={Talk} alt="First slide" />
            </div>
          </div>
          <div className="col-md-12 big-img">
            {" "}
            <img className="col-md-11 " src={Lib} alt="First slide" />
          </div>
        </div>
      </div>
    </>
