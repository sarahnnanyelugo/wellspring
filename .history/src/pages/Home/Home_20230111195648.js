  ...
  return (
    <>
      ...
      <div className="actions col-md-12 flexy">
        <div className="col-md-1">&nbsp;</div>
        <div className="col-md-10 flexy">
<div className="col-md-4 action-box"><div><h5>REQUEST INFORMATION</h5></div></div>
<div className="col-md-4  action-box"><h5>SCHEDULE A TOUR</h5></div>
<div className="col-md-4  action-box"><h5>APPLY NOW</h5></div>
