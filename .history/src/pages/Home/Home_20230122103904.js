...
export const Home = () => {
  const pageProps=
{
heading:"This is heading value",
subheading:"This is the subheading value",
paragraph:["p:This is the first paragraph","pic:http://pictureurl.jpg","p:This is a second paragraph.","ul:This is the first list item, this is the second list item "]}
  return (
    <>
      ...
      <section className="module1 contentt contact-form prefooter-container">
       ...
       <section className="module1 contentt contact-form prefooter-container"></section>
      <TestPage pageProps={pageProps} />
