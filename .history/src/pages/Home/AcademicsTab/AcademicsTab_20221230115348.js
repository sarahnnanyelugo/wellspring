...
import Pic2 from "../../../assets/kick.png";
import Pic3 from "../../../assets/tour2.png";
import Pic4 from "../../../assets/tour2.png";
          ...
          <div className="tabby-tab">
            ...
            <div className="tabby-content col-md-12">
              <TabContent
                ...
                url1="#"
                url2="#"
                title2="Teachers Appreciation Day"
                paragraph2="All parents want their child to attend a great school – not just a good school. When my wife and I moved our family to Orlando several years ago, we found a great school in The First Academy. On the first day of the new school year, I watched with apprehension from a second story window as my middle child walked onto a playground crowded with unfamiliar faces."
              />
            </div>
          </div>
          <div className="tabby-tab">
