            ...
            >
              <div className="col-md-11 col-12">
                ...
                <Testimonials
                  testifierImg={Speech}
                  testifier="name of testifier"
                  content="Wellspring College is a res students to stand out from their peers and become."
                />
              </div>
              <div className="col-md-11 col-12">
                {" "}
                <Testimonials
                  testifierImg={Principal}
                  testifier="name of testifier"
                  content="The s students to stand out from their peers and become leaders who influence the world ."
                />
              </div>
              ...
              <div className="col-md-11 col-12">
                ...
                <Testimonials
                  testifierImg={Principal}
                  testifier="name of testifier"
                  content="The s students to stand out from their peers and become leaders who influence the  wisdom beyond scholarship, service before self, of life."
                />
              </div>
              ...
              <div className="col-md-11 col-12">
                ...
                <Testimonials
                  testifierImg={Principal}
                  testifier="name of testifier"
                  content="The s students to stand out from their peers and become leaders who influence the world through Christ-like leadership — ."
                />{" "}
              </div>
              ...
              <div className="col-md-11 col-12">
                ...
                <Testimonials
                  testifierImg={Principal}
                  testifier="name of testifier"
                  content="The s students to stand out from their peers and become great.The s students to stand out from their peers and become great."
                />
              </div>
              ...
              <div className="col-md-11 col-12">
                ...
                <Testimonials
                  testifierImg={Principal}
                  testifier="name of testifier"
                  content="The s students to stand out from their peers and become leaders ."
                />
              </div>
            </Carousel>
          </div>
