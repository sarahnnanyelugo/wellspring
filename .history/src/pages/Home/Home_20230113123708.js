  ...
  return (
    <>
      ...
      <div className="col-md-12 news-container">
        ...
        <section className="module content col-md-12 wellspring-happenings">
          <h1>WELLPRING HAPPENINGS</h1>
          <div className="container col-md-12 flexy">
            <div className="col-md-2">&nbsp;</div>
      ...
      {/* <div className="col-md-12 wellspring-happenings module content contact-form">
        <h1>WELLPRING HAPPENINGS</h1>
        <div className="col-md-12 flexy container">
          <div className="col-md-2">&nbsp;</div>
          <div className="col-md-8 flexy">
      ...
      <section className="module content contact-form">
