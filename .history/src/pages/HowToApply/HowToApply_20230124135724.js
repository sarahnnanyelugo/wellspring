        ...
        <div className="col-md-8">
          <div className="col-md-11">
            ...
            <p>
              ...
              the information necessary to complete the <strong></strong>for your child. At this
              point, you should be able to login and out of your account and
              access your child’s application at any time by selecting the
              Student’s Name.
            </p>
          </div>
        </div>
