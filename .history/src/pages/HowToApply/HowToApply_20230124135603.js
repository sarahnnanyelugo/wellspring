      ...
      <section className="page-content flexy ">
        ...
        <div className="col-md-8">
          <div className="col-md-11">
            ...
            To begin the Online Application process, Create an Account on the
            Application page. Then log into your account and provide the
            information necessary to complete the Create A New Student
            Application for your child. At this point, you should be able to
            login and out of your account and access your child’s application at
            any time by selecting the Student’s Name.
          </div>
        </div>
      </section>
