      ...
      <section className="col-md-12 flexy page-background ">
        <div className="col-md-12 page-shadow header-wrapper wellspring-header">
          ...
          <div className="icon ">
            <h1>Campus Visits</h1>
            <p>
              <em>We would love to meet you!</em>
            </p>
            <h1>
      ...
      <section className="page-content flexy ">
        ...
        <div className="col-md-8">
          <div className="col-md-11">
            ...
            <h2 className="page-headings mb3">Campus Visits</h2>
            ...
            <p>
              ...
              407-206-8602 or admissions@thefirstacademy.org to schedule a tour
              of our Lower School, Middle School, and/or Upper School, Library,
              Gymnasium, Chapel, Dining Facility, Fine Arts and Performing Arts
              areas, and the Payne Stewart Athletic Complex. We have on-campus
              and virtual tours available.
            </p>
            <p>
              Schedule your personal tour or RSVP for an Admissions Event here.
            </p>
          </div>
        </div>
      </section>
