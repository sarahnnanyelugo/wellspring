            ...
            <div className="col-md-12 contact-container flexy">
              <div className="col-md-4">
                ...
                <ul className="list-unstyled list-inline">
                  <li className="list-inline-item"><a href={CampusMap} target="_blank">Campus Map</a></li>
                  <li className="list-inline-item"><a href={CampusMap} target="_blank">Download</a></li>
                </ul>
              </div>
              <div className="col-md-8">
                <iframe
