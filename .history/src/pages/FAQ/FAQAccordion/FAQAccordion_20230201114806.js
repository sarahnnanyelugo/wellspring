      ...
      <Accordion defaultActiveKey="0">
        ...
        <Accordion.Item eventKey="6">
          ...
          <Accordion.Body>
            ...
            <p>
              The<Link to={"/"} className="random-link"></Link> After School
              Program provides supervised student activities KPrep through 12th
              grade, until 6:00 PM. Our Preschool students have the option to do
              Wrap Around Care.
            </p>
          </Accordion.Body>
        </Accordion.Item>
