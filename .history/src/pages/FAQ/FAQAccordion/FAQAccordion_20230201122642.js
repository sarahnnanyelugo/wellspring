    ...
    <div className="faq-accordion-container">
      ...
      <Accordion defaultActiveKey="0">
        ...
        <Accordion.Item eventKey="12">
          <Accordion.Header>
            <h2 className="page-headings">
              What sports are offered at The First Academy?
            </h2>
          </Accordion.Header>
          <Accordion.Body>
            <p>
              The First Academy has a solid reputation in the state of Florida
            ...
            <p>
              Additionally, The First Academy offers a robust Lower School
        ...
        <Accordion.Item eventKey="13">
          <Accordion.Header>
            <h2 className="page-headings">
              How does The First Academy incorporate technology into the
        ...
        <Accordion.Item eventKey="15">
          <Accordion.Header>
            <h2 className="page-headings">
              Does The First Academy offer after-school care?
            </h2>
          </Accordion.Header>
          <Accordion.Body>
            <p>
        ...
        <Accordion.Item eventKey="16">
          <Accordion.Header>
            <h2 className="page-headings">
              Can my child visit The First Academy before deciding?
            </h2>
          </Accordion.Header>
          <Accordion.Body>
            <p>
        ...
        <Accordion.Item eventKey="18">
          ...
          <Accordion.Body>
            <p>
              At The First Academy, we have what is called a “wait pool”. The
              First Academy’s wait pool is an unranked group of students who
              have been accepted to The First Academy, and who we prayerfully
        ...
        <Accordion.Item eventKey="19">
          ...
          <Accordion.Body>
            <p>
              Email admissions@thefirstacademy.org or give us a call at (407)
              206-8602 and we will be more than happy to help.
            </p>
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="20">
          <Accordion.Header>
            <h2 className="page-headings">Nondiscriminatory Policy</h2>
          </Accordion.Header>
