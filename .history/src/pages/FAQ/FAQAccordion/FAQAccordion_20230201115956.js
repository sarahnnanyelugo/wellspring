        ...
        <Accordion.Item eventKey="9">
          ...
          <Accordion.Body>
            <p>
              ...
              <Link to={"/"} className="random-link"></Link>multiple
              scholarships administered by Step Up for Students. However, these
              <Link to={"/"} className="random-link"></Link>scholarships will
              not cover the full cost of our{" "}
              <Link to={"/"} className="random-link"></Link>Tuition and Fees.
