    ...
    <div className="faq-accordion-container">
      ...
      <Accordion defaultActiveKey="0">
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            <p>
              The First Academy was founded in 1986. Starting with grades K-6,
              the school added a grade level each year until our first senior
              class graduated in 1994. In each of the classes graduating since
              that time, every graduating senior has been accepted to college.
            </p>
          </Accordion.Body>
        </Accordion.Item>
