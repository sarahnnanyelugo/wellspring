    ...
    <div className="faq-accordion-container">
      ...
      <Accordion defaultActiveKey="0">
        ...
        <Accordion.Item eventKey="7">
          ...
          <Accordion.Body>
            <p>
              Our <Link to={"/"} className="random-link"></Link>uniform provider
              is Dennis Uniforms. Items can be purchased online or in store at
              1101 N. Keller Road, Suite G-3, Orlando, FL 32810. Please review
              our Uniform Policies in the Parent-Student Handbook or Back to
              School Packet. Sunshine uniforms are not permitted.
            </p>
            <p>
