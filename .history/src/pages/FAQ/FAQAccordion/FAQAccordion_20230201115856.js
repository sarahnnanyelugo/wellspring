    ...
    <div className="faq-accordion-container">
      ...
      <Accordion defaultActiveKey="0">
        ...
        <Accordion.Item eventKey="9">
          ...
          <Accordion.Body>
            <p>
              The First Academy accepts multiple scholarships administered by
              Step Up for Students. However, these scholarships will not cover
              the full cost of our Tuition and Fees. Families will be
              financially responsible for the remaining balance. Please reach
              out to our Business Office for additional information,
              407-206-8758.
            </p>
            <p>
              The First Hope accepts the Family Empowerment Scholarship. To
              learn more please call 407-206-8801 or visit The First Hope.
            </p>
            <p>
              The Classical School does not accept scholarships of any kind. To
              learn more about The Classical School Tuition and Fees, please
              call 407-206-8762 or visit The Classical School.
            </p>
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="7">
