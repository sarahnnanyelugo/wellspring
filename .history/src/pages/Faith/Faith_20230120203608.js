      ...
      <section className="page-content flexy ">
        ...
        <div className="col-md-8">
          <div className="col-md-11">
            ...
            <p>
              Our mission at The First Academy is to prepare children for life
              as Christian leaders who choose character before career, wisdom
              beyond scholarship, service before self, and participation as a
              way of life. This is thoroughly a spiritual endeavor empowered and
              sustained by God and executed by us through…
            </p>
            <h4 className="page-headings">The Head</h4>
            <p>
              <strong>
