  ...
  return (
    <>
      <div class="diversity-tab-container2">
        ...
        <div class="tab-wrap2">
          <input type="radio" id="tab1" name="tabGroup1" class="tab2" checked />
          <label for="tab1" className="cool-link">
            Historical Background
          </label>
          <input type="radio" id="tab2" name="tabGroup1" class="tab2" checked />
          <label for="tab2" className="cool-link">
            Diversity Task Force
          </label>{" "}
          <input type="radio" id="tab3" name="tabGroup1" class="tab2" checked />
          ...
          <div class="tab__content2">
            ...
            <div className="col-md-12 flexy">
              <div className="col-md-8">
                <p>
                  Psalm 139: <br />
                  “I am marvelously made! You know me inside and out, you know
                  every bone in my body; You know exactly how I was made, bit by
                  bit, how I was sculpted from nothing into something. Like an
                  open book, you watched me grow from conception to birth; all
                  the stages of my life were spread out before you, Your
                  thoughts—how rare, how beautiful! God, I’ll never comprehend
                  them! I couldn’t even begin to count them— any more than I
                  could count the sand of the sea.”
                </p>
              </div>
              <div className="col-md-4">
                {" "}
                <img className="col-md-12 " src={Piano} alt="Scholar" />
              </div>
            </div>
            <p>
              Frederick Douglass said, “I know of no rights of race superior to
              the rights of humanity.” To be human is a staggering reality. God
              – who created from nothing – made each and every man, woman, boy,
              and girl in His image, which is to say that in our humanity we all
              bear the marks of our maker. He has uniquely designed humanity so
              that we might live in community with him (and each other!) and
              enjoy him (and each other!) forever.
            </p>{" "}
            <h6>
              Fourth, we believe the best about every member of our school
              community.
            </h6>
            <div className="col-md-12 flexy">
              <div className="col-md-8">
                <p>
                  John 17: 20-22:
                  <br />
                  “The goal is for all of them to become one heart and mind—just
                  as you, Father, are in me and I in you, so they might be one
                  heart and mind with us. Then the world might believe that you,
                  in fact, sent me. The same glory you gave me, I gave them, so
                  they’ll be as unified and together as we are—I in them and you
                  in me. Then they’ll be mature in this oneness, and give the
                  godless world evidence that you’ve sent me and loved them in
                  the same way you’ve loved me.”
                </p>
              </div>
              <div className="col-md-4">
                {" "}
                <img className="col-md-12 " src={Computer} alt="Scholar" />
              </div>
            </div>
            <p>
              As God’s image-bearers and as members of the school community, we
              follow the teaching of John 17 and believe the best about each
              other, to create a culture of mutual respect, and to encourage
              deep affection for one another. The fruit of these labors is a
              learning environment which shapes not only the mind but the heart
              as well and produces the kind of people who are prepared to be
              God-exalting, others-focused leaders in their homes, churches, and
              communities.
            </p>
          </div>
        </div>
