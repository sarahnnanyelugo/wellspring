      ...
      <div className="footer-container col-md-12 ">
        <div className="col-md-12 flexy footer-content">
          ...
          <div className="col-md-10 flexy">
            ...
            <div className="col-md-3" style={{textAlign}}>
              {" "}
            ...
            <div className="col-md-2">
              <ul className="list-unstyled">
                <li><Link className="link-alteration">ALUMNI</Link></li>
                <li><Link className="link-alteration">CAREERS</Link></li>
                <li><Link className="link-alteration">CURRENT FAMILIES</Link></li>
                <li><Link className="link-alteration">EVENTS</Link></li>
                <li><Link className="link-alteration">GIVING</Link></li>
                <li><Link className="link-alteration">NEWS & STORIES</Link></li>
                <li><Link className="link-alteration">STORE</Link></li>
                <li><a className="link-alteration"></a>PRIVACY POLICY</li>
              </ul>
            </div>
          </div>
        </div>
