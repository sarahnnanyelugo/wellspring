            ...
            <div className="col-md-6 flexy">
              <ul className="list-unstyled list-inline">
                <li className="list-inline-item ">
                  <Link to={"#"} className="link-alteration">Alumni</Link>
                </li> <li className="list-inline-item ">
                  <Link to={"#"} className="link-alteration">Careers</Link>
                </li> <li className="list-inline-item ">
                  <Link to={"#"} className="link-alteration">Volunteer</Link>
                </li> <li className="list-inline-item ">
                  <Link to={"#"} className="link-alteration">Family Portal</Link>
                </li>
              </ul>
              <div className="col-md-6">&nbsp;</div>{" "}
            </div>
