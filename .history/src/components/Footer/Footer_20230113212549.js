        ...
        <div className="col-md-12 flexy footer-content">
          ...
          <div className="col-md-10 flexy">
            ...
            <div className="col-md-4">
              ...
              <small>
                © 2023 The First Academy. A Preschool-Grade 12 Christ-Centered
                College Preparatory School. All Rights Reserved. Copyright 2022
                Wellspring College. All Rights Reserved
              </small>
            </div>
          </div>
        </div>
