    ...
    <>
        ...
        <div className="col-md-12 flexy footer-content">
          ...
          <div className="col-md-11 flexy">
            ...
            <div className="col-md-5 logo-con">
              {" "}
              <center>
                <img className="col-md-7" src={Logo} alt="Scholar" />
            ...
            <div className="col-md-2">
              <ul className="list-unstyled">
                ...
                <li>
                  <Link className="link-alteration" to={"/admission-events"}>
                    ADMISSION EVENTS
                  </Link>
                </li>
                <li>
                  <Link className="link-alteration" to={"/media"}>
                    MEDIA
                  </Link>
                </li>
                <li>
                  <Link className="link-alteration" to={"/tuition"}>
                    TUITION
                  </Link>
                </li>
                <li>
                  <Link className="link-alteration" to={"/how-to-apply"}>
                    HOW TO APPLY
                  </Link>
                </li>
                <li>
                  <Link className="link-alteration" to={"/faith"}>
                    FAITH
                  </Link>
                </li>
                <li>
                  <a className="link-alteration" href={"#"} target="_blank"></a>
                  PRIVACY POLICY
                </li>
              </ul>
            </div>
      ...
      <div className="col-md-12 post-footer flexy">
        ...
        <div className="col-md-3 educare flexy flexyM">
          ...
          <p>Powered by</p>
          <a href="https://www.educare.school/" target="_blank">
            {" "}
