    ...
    sandbox="allow-top-navigation allow-top-navigation-by-user-activation allow-downloads
     allow-scripts allow-same-origin allow-popups allow-forms" allowfullscreen="" webkitallowfullscreen=""
      ...
      <Accordion.Item eventKey="3">
        ...
        <Accordion.Body>
        <ul className="list-unstyled">
            <li>The First Academy Wordmark <a href={"#"} target=_blank class>(Download Wordmark)</a></li>
            <li>The First Academy Athletics Spirit Icon – Lion Head <a href={"#"}>(Download Spirit Icons)</a></li>
            <li>The First Academy Athletics – Lion (Download Lion Logos)</li>
            <li>The First Academy Athletics – Royals (Download Royals Logos)</li>
        </ul>
        <small><em>Please Note: After downloading the files above, please open then extract the zip files; otherwise you will not be able to edit, print or make changes to the files.
</em></small>
        </Accordion.Body>
      </Accordion.Item>
    </Accordion>
