...
<ul className="list-unstyled">
    ...
    <div data-url="https://issuu.com/thefirstacademy/docs/brand_and_graphic_standards"
      className="issuuembed issuu-isrendered col-md-12">
        <iframe src="https://e.issuu.com/embed.html?identifier=ey7whxb16t0w&amp;embedType=script&amp;u=thefirstacademy&amp;d=brand_and_graphic_standards&amp;p=1"  title="issuu.com" style={{width:'100%',}}
