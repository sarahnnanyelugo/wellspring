      ...
      <div className="col-md-12 form-header">
       ...
       <Accordion.Item eventKey="5">
        ...
        <p>The First Academy does not sell your information, nor provide p
            ermission to share or re-use your information. In order to send mail, The First Academy provides address information for mailing. To process payments, your transaction informations are securely sent to a 
