    ...
    sandbox="allow-top-navigation allow-top-navigation-by-user-activation allow-downloads
     allow-scripts allow-same-origin allow-popups allow-forms" allowfullscreen="" webkitallowfullscreen=""
      ...
      <Accordion.Item eventKey="3">
        ...
        <small class><em>Please Note: After downloading the files above, please open then extract the zip files; otherwise you will not be able to edit, print or make changes to the files.
</em></small>
        </Accordion.Body>
      </Accordion.Item>
    </Accordion>
