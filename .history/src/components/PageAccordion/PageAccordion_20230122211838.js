...
<ul className="list-unstyled">
    ...
    sandbox="allow-top-navigation allow-top-navigation-by-user-activation allow-downloads
     allow-scripts allow-same-origin allow-popups allow-forms" allowfullscreen="" webkitallowfullscreen="" mozallowfullscreen="" msallowfullscree="" allow="clipboard-write"></iframe></div>
        </Accordion.Body>
      </Accordion.Item>
    </Accordion>
  );
