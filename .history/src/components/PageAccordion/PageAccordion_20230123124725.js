...
const PageAccordion = () => {
    ...
    <li><img className="col-md-12 dot" src={Blue} alt="Scholar" />
{person}</li>
  )
   return (
...
<p>We may ban anyone posting material that falls into the above categories from participating in any of our outlets.

</p>
<p>The First Academy respects your privacy and will not share your personal information without your consent. However, if you choose to post your personal information on these outlets, it will be available for others to see and use.

</p>
<p>The First Academy reserves the right to change these terms and its content at any time.
