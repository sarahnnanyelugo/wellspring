     ...
     allow-scripts allow-same-origin allow-popups allow-forms" allowfullscreen="" webkitallowfullscreen=""
      ...
      <div className="col-md-12 form-header">
       ...
       <Accordion.Item eventKey="5">
        ...
        <Accordion.Body>
        <p>The First Academy does not sell your information, nor provide permission to share or re-use your information. In order to send mail, The First Academy provides address information for mailing. To process payments, your transaction informations are securely sent to a payment processor. As technology continues to evolve, we reserve the right to change our policy at any time.</p>
        </Accordion.Body>
      </Accordion.Item>
    </Accordion>
  );
