...
the greatest number of AP Exams, and then the highest average score (at least 3.5) on all AP Exams taken
                ...
                {" "}
                <img className="col-md-12 dot" src={Blue} alt="Scholar" />
<strong>National  AP Scholar:</strong> Granted to the one male and one female student in each U.S. state and the District of Columbia with scores of 3 or higher on 
the greatest number of AP Exams, and then the highest average score (at least 3.5) on all AP Exams taken
