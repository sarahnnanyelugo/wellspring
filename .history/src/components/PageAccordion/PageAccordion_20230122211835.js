...
<ul className="list-unstyled">
    ...
    <div data-url="https://issuu.com/thefirstacademy/docs/brand_and_graphic_standards"  class="issuuembed issuu-isrendered"><iframe src="https://e.issuu.com/embed.html?identifier=ey7whxb16t0w&amp;embedType=script&amp;u=thefirstacademy&amp;d=brand_and_graphic_standards&amp;p=1" style="border:none;width:100%;height:100%;" title="issuu.com" 
    sandbox="allow-top-navigation allow-top-navigation-by-user-activation allow-downloads allow-scripts allow-same-origin allow-popups allow-forms" allowfullscreen="" webkitallowfullscreen="" mozallowfullscreen="" msallowfullscree="" allow="clipboard-write"></iframe></div>
        </Accordion.Body>
      </Accordion.Item>
    </Accordion>
  );
