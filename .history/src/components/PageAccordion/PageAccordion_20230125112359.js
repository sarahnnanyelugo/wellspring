      ...
      <Accordion.Item eventKey="0">
        ...
        <Accordion.Body>
          ...
          <p>
            ...
            National Merit Scholarship Semifinalist! Of the 1.5 million entrants
            around the world, only 16,000 high school seniors qualified for this
            recognition after taking the PSAT/NMSQT® their junior year. We are
            so proud of Enzo for this achievement.
          </p>
          <p>
          ...
          <p>
            ...
            recognized as CollegeBoard’s AP scholars for various levels. We are
            proud of this special recognition and we believe that our students
            are making a positive impact on our AP program.
          </p>
          ...
          <ul className="list-unstyled">
            ...
            <li>
              {" "}
              <img className="col-md-12 dot" src={Blue} alt="Scholar" />
              <strong>AP Scholar with Distinction:</strong> Granted to students
            ...
            <li>
              {" "}
              <img className="col-md-12 dot" src={Blue} alt="Scholar" />
              <strong>State AP Scholar:</strong> Granted to the one male and one
              female student in each U.S. state and the District of Columbia
              with scores of 3 or higher on the greatest number of AP Exams, and
            ...
            <li>
              ...
              United States who receive an average score of at least 4 on all AP
              Exams taken, and scores of 4 or higher on eight or more of these
              exams
            </li>{" "}
            <p>
              You can see your award by logging in to your CollegeBoard account
              where you viewed your AP scores.
            </p>
          </ul>
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="1">
        ...
        <Accordion.Body>
          <p>
            ...
            Independent Schools (FCIS), the Florida Kindergarten Council (FKC),
            the Southern Association of Independent Schools (SAIS), the Southern
            Association of Colleges and Schools (SACS), and the Association of
            Christian Schools International (ACSI).
          </p>
          <ul className="list-unstyled key1-list">
            <li>
              <span>¹ACSI</span>………………………………………Association of Christian Schools
              International
            </li>{" "}
            <li>
            ...
            <li>
              <span>NASSP</span>………………………………………National Association of Secondary
              School Principals
            </li>{" "}
            <li>
              <span>SACAC</span>………………………………………Southern Association for College
              Admission Counseling
            </li>{" "}
            <li>
              <span>NACAC</span>………………………………………National Association for College
              Admission Counseling
            </li>
          </ul>
      ...
      <Accordion.Item eventKey="2">
        ...
        <Accordion.Body>
          <p>
            ...
            These include but are not limited to Marketing materials, Print and
            Web Media, Signs, Videos and other merchandise. In addition, the
            guide assists approved web and graphic designers, printers,
            advertising agencies, Administration and approved users.
          </p>
          <p>
            The Standards are not made to prevent creativity, but to protect our
            visual identity and brand. Consistent application will help to
          ...
          <h2 className="page-headings">Branding & Graphic Standards Guide</h2>
      ...
      <Accordion.Item eventKey="5">
        ...
        <Accordion.Body>
          <p>
            ...
            To process payments, your transaction informations are securely sent
            to a payment processor. As technology continues to evolve, we
      ...
      <Accordion.Item eventKey="6">
        ...
        <Accordion.Body>
          ...
          <p>
            ...
            Please understand that Wellspring College may remove postings that
            are:
          </p>
          ...
          <p>
            Wellspring College reserves the right to change these terms and its
            content at any time.
          </p>
        </Accordion.Body>
      </Accordion.Item>
