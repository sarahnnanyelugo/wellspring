        ...
        <div className={classes.navCont}>
          ...
          <ul className={click ? "nav-list active" : "nav-list"}>
            ...
            >
              ...
              {activeMenu.menu3 && <Dropdown menuArray={navMenus.artss} />}
            </li>
            <li
              className="nav-item "
              onMouseEnter={onMouseEnter}
            ...
            >
              ...
              {activeMenu.menu3 && <Dropdown menuArray={navMenus.athletics} />}
            </li>
            ...
            >
              ...
              {activeMenu.menu3 && <Dropdown menuArray={navMenus.giving} />}
            </li>
