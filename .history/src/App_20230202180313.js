...
import { CampusVisits } from "./pages/CampusVisits/CampusVisits";
import { AdmissionsEvents } from "./pages/AdmissionsEvents/AdmissionsEvents";
import { CommingSoon } from "./pages/CommingSoon/CommingSoon";
import { FAQ } from "./pages/FAQ/FAQ";
import { NewFamilyInfo } from "./pages/NewFamily-Info/NewFamilyInfo";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="campus-visits" element={<CampusVisits />} />
        <Route path="admissions-events" element={<AdmissionsEvents />} />
        <Route path="faqs" element={<FAQ />} />
        <Route path="new-family-info" element={<NewFamilyInfo />} />
