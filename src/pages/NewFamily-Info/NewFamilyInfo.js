    ...
    <>
      <section className="col-md-12 flexy page-background ">
        <div className="col-md-12 page-shadow header-wrapper wellspring-header">
          <div className="col-md-12 bannerNF zoominheader"></div>
      ...
      <section className="page-content flexy ">
        ...
        <div className="col-md-10">
          <div className="col-md-11">
            ...
            <ul className="list-unstyled dotted">
              <li>
              ...
              <li>
                <Link to={"/"} className="random-link">
                  TFA Family Portal App User Instructions
                </Link>
              </li>
            </ul>
            <p>
              If you have any additional technical questions, please use this
              form to receive customized help as a New Family.
            </p>
            <h2 className="page-headings mb3">New Family Tech Support</h2>
            <p>Have a question for our tech team? Fill out this online form.</p>
            <h2 className="page-headings mb3">New Parent & Family Events</h2>
            <h5 className="page-headings mb3">Details & Donuts</h5>
            <p>
              Join us for our New Family Details & Donuts orientation events.
              This event will provide tips for transitioning to The First
              Academy. RSVP for one of the following dates:
            </p>
            <div className="col-md-12 new-fam-events">
              <center>
                <h3>New Family Events</h3>
              </center>
            </div>
            <p>Check back in the spring for summer and fall dates!*</p>
          </div>
        </div>
      </section>
